...
\begin{abstract}
	...
	Using MNIST as a dataset, we benchmark uniform quantisation (mapping real
	values to evenly spaced levels via a single step size), mixed-precision
	formats, and post-training decimal rounding. We compare end-to-end
	low-precision training, inference-only quantisation, and mixed-precision with
